...
namespace windowing
{
	...
	protected:
		...
		bool on_command_default(uint16_t identifier, uint16_t notification_code, HWND control_handle)
		{
			...
			using details::this_cast;
			if constexpr (details::detect_v<wmt::get_commandhandler_t>)
			{
				constexpr const bool return_handler = details::same_return_v<wmt::get_commandhandler_t, command_handler_list &>;
				constexpr const bool return_chandler = details::same_return_v<wmt::get_commandhandler_t, const command_handler_list &>;
		...
		std::pair<LRESULT, bool> default_message_handler(UINT msg, WPARAM wparam, LPARAM lparam)
		{
			...
			case WM_CREATE:
			{
				if constexpr (detect_v<wmt::on_create_t>)
				{
					constexpr const bool return_bool = same_return_v<wmt::on_create_t, bool>;
					constexpr const bool return_cbool = convertable_return_v<wmt::on_create_t, bool>;
					constexpr const bool return_void = same_return_v<wmt::on_create_t, void>;
			...
			case WM_DESTROY:
			{
				if constexpr (detect_v<wmt::on_destroy_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_destroy_t, void>;
			...
			case WM_MOVE:
			{
				if constexpr (detect_v<wmt::on_move_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_move_t, void>;
			...
			case WM_SIZE:
			{
				if constexpr (detect_v<wmt::on_size_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_size_t, void>;
			...
			case WM_ACTIVATE:
			{
				if constexpr (detect_v<wmt::on_activate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_activate_t, void>;
			...
			case WM_SETFOCUS:
			{
				if constexpr (detect_v<wmt::on_setfocus_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_setfocus_t, void>;
			...
			case WM_KILLFOCUS:
			{
				if constexpr (detect_v<wmt::on_killfocus_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_killfocus_t, void>;
			...
			case WM_ENABLE:
			{
				if constexpr (detect_v<wmt::on_enable_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_enable_t, void>;
			...
			case WM_SETREDRAW:
			{
				if constexpr (detect_v<wmt::on_setredraw_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_setredraw_t, void>;
			...
			case WM_SETTEXT:
			{
				if constexpr (detect_v<wmt::on_settext_t>)
				{
					static constexpr bool convertable_ret = convertable_return_v<wmt::on_settext_t, bool>;
			...
			case WM_GETTEXT:
			{
				if constexpr (detect_v<wmt::on_gettext_t>)
				{
					constexpr bool convertable_ret = convertable_return_v<wmt::on_gettext_t, uintptr_t>;
			...
			{
				if constexpr (detect_v<wmt::on_gettextlength_t>)
				{
					constexpr bool convertable_ret = convertable_return_v<wmt::on_gettextlength_t, uintptr_t>;
					//This static_assert is deliberately unconditional.
					//The behaviour of WM_GETTEXT is compromised if we cannot return a value.
			...
			case WM_PAINT:
			{
				constexpr const bool simple_paint = detect_v<wmt::simple_on_paint_t>;
				constexpr const bool default_paint = detect_v<wmt::default_on_paint_t>;
				...
				{
					constexpr const bool return_void = same_return_v<wmt::simple_on_paint_t, void>;
				...
				{
					constexpr const bool return_void = same_return_v<wmt::default_on_paint_t, void>;
					if constexpr (return_type_assert) static_assert(return_void, "on_paint with a return that is not void found. Ignoring return.");
			...
			case WM_CLOSE:
			{
				if constexpr (detect_v<wmt::on_close_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_close_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_queryendsession_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_queryendsession_t, bool>;
			...
			case WM_QUERYOPEN:
			{
				if constexpr (detect_v<wmt::on_queryopen_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_queryopen_t, bool>;
			...
			case WM_ERASEBKGND:
			{
				if constexpr (detect_v<wmt::on_erasebkgnd_t>)
				{
					constexpr const bool return_bool = same_return_v<wmt::on_erasebkgnd_t, bool>;
					constexpr const bool return_cbool = convertable_return_v<wmt::on_erasebkgnd_t, bool>;
					constexpr const bool return_void = same_return_v<wmt::on_erasebkgnd_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_syscolorchange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_syscolorchange_t, void>;
			...
			case WM_ENDSESSION:
			{
				if constexpr (detect_v<wmt::on_endsession_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_endsession_t, void>;
			...
			case WM_SHOWWINDOW:
			{
				if constexpr (detect_v<wmt::on_showwindow_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_showwindow_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_settingchange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_settingchange_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_devmodechange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_devmodechange_t, void>;
			...
			case WM_ACTIVATEAPP:
			{
				if constexpr (detect_v<wmt::on_activateapp_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_activateapp_t, void>;
			...
			case WM_FONTCHANGE:
			{
				if constexpr (detect_v<wmt::on_fontchange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_fontchange_t, void>;
			...
			case WM_TIMECHANGE:
			{
				if constexpr (detect_v<wmt::on_timechange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_timechange_t, void>;
			...
			case WM_CANCELMODE:
			{
				if constexpr (detect_v<wmt::on_cancelmode_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_cancelmode_t, void>;
			...
			case WM_SETCURSOR:
			{
				if constexpr (detect_v<wmt::on_setcursor_t>)
				{
					constexpr const bool return_bool = same_return_v<wmt::on_setcursor_t, bool>;
					constexpr const bool return_cbool = convertable_return_v<wmt::on_setcursor_t, bool>;
					constexpr const bool return_void = same_return_v<wmt::on_setcursor_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_mouseactivate_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_mouseactivate_t, mouse_activate_type>;
					constexpr const bool integral_return = integral_return_v<wmt::on_mouseactivate_t>;
			...
			{
				if constexpr (detect_v<wmt::on_childactivate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_childactivate_t, void>;
			...
			case WM_QUEUESYNC:
			{
				if constexpr (detect_v<wmt::on_queuesync_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_queuesync_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_getminmaxinfo_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_getminmaxinfo_t, void>;
			...
			case WM_NEXTDLGCTL:
			{
				if constexpr (detect_v<wmt::on_nextdlgctl_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_nextdlgctl_t, void>;
			...
			case WM_DRAWITEM:
			{
				if constexpr (detect_v<wmt::on_drawitem_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_drawitem_t, void>;
			...
			case WM_MEASUREITEM:
			{
				if constexpr (detect_v<wmt::on_measureitem_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_measureitem_t, void>;
			...
			case WM_DELETEITEM:
			{
				if constexpr (detect_v<wmt::on_deleteitem_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_deleteitem_t, void>;
			...
			case WM_VKEYTOITEM:
			{
				if constexpr (detect_v<wmt::on_vkeytoitem_t>)
				{
					constexpr const bool convertable_int = convertable_return_v<wmt::on_vkeytoitem_t, int32_t>;
			...
			case WM_CHARTOITEM:
			{
				if constexpr (detect_v<wmt::on_chartoitem_t>)
				{
					constexpr const bool convertable_int = convertable_return_v<wmt::on_vkeytoitem_t, int32_t>;
					static_assert(convertable_int, "on_vkeytoitem must have a return that is convertable to int32_t.");
			...
			case WM_SETFONT:
			{
				if constexpr (detect_v<wmt::on_setfont_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_setfont_t, void>;
			...
			case WM_GETFONT:
			{
				if constexpr (detect_v<wmt::on_getfont_t>)
				{
					constexpr const bool return_hfont = same_return_v<wmt::on_getfont_t, HFONT>;
			...
			case WM_SETHOTKEY:
			{
				if constexpr (detect_v<wmt::on_sethotkey_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_sethotkey_t, set_hot_key_result>;
					constexpr const bool integral_return = integral_return_v<wmt::on_sethotkey_t>;
			...
			case WM_GETHOTKEY:
			{
				if constexpr (detect_v<wmt::on_gethotkey_t>)
				{
					constexpr const bool return_hot_key_value = same_return_v<wmt::on_gethotkey_t, hot_key_value>;
			...
			case WM_COMPAREITEM:
			{
				if constexpr (detect_v<wmt::on_compareitem_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_compareitem_t, compare_item_result>;
					constexpr const bool integral_return = integral_return_v<wmt::on_compareitem_t>;
			...
			case WM_GETOBJECT:
			{
				if constexpr (detect_v<wmt::on_getobject_t>)
				{
					constexpr const bool convertable_return = convertable_return_v<wmt::on_getobject_t, LRESULT>;
			...
			{
				if constexpr (detect_v<wmt::on_windowposchanging_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_windowposchanging_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_windowposchanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_windowposchanged_t, void>;
			...
			case WM_COPYDATA:
			{
				if constexpr (detect_v<wmt::on_copydata_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_copydata_t, bool>;
			...
			case WM_NOTIFY:
			{
				if constexpr (detect_v<wmt::on_notify_t>)
				{
					constexpr const bool return_complex = convertable_return_v<wmt::on_notify_t, std::pair<LRESULT, bool>>;
				...
				{
					if constexpr (detect_v<wmt::get_commandhandler_t>)
					{
						constexpr const bool return_command_list = same_return_v<wmt::get_commandhandler_t, command_handler_list &>;
						constexpr const bool return_ccommand_list = same_return_v<wmt::get_commandhandler_t, const command_handler_list &>;
			...
			{
				if constexpr (detect_v<wmt::on_inputlangchangerequest_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_inputlanguagechangerequest_t, bool>;
			...
			{
				if constexpr (detect_v<wmt::on_inputlangchange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_inputlanguagechange_t, void>;
			...
			case WM_TCARD:
			{
				if constexpr (detect_v<wmt::on_tcard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_tcard_t, void>;
			...
			case WM_HELP:
			{
				if constexpr (detect_v<wmt::on_help_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_help_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_notifyformat_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_notifyformat_t, notify_format_result>;
					constexpr const bool integral_return = integral_return_v<wmt::on_notifyformat_t>;
			...
			case WM_CONTEXTMENU:
			{
				if constexpr (detect_v<wmt::on_contextmenu_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_contextmenu_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_stylechanging_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_stylechanging_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_stylechanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_stylechanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_displaychange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_displaychange_t, void>;
			...
			case WM_GETICON:
			{
				if constexpr (detect_v<wmt::on_geticon_t>)
				{
					constexpr const bool return_hicon = same_return_v<wmt::on_geticon_t, HICON>;
			...
			case WM_SETICON:
			{
				if constexpr (detect_v<wmt::on_seticon_t>)
				{
					constexpr const bool return_hicon = same_return_v<wmt::on_seticon_t, HICON>;
			...
			case WM_NCCREATE:
			{
				if constexpr (detect_v<wmt::on_nccreate_t>)
				{
					constexpr const bool return_bool = same_return_v<wmt::on_nccreate_t, bool>;
					constexpr const bool return_cbool = convertable_return_v<wmt::on_nccreate_t, bool>;
					constexpr const bool return_void = same_return_v<wmt::on_nccreate_t, void>;
			...
			case WM_NCDESTROY:
			{
				if constexpr (detect_v<wmt::on_ncdestroy_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncdestroy_t, void>;
			...
			case WM_NCCALCSIZE:
			{
				if constexpr (detect_v<wmt::on_nccalcsize_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_nccalcsize_t, nccalcsize_return>;
					constexpr const bool integral_return = integral_return_v<wmt::on_nccalcsize_t>;
			...
			case WM_NCHITTEST:
			{
				if constexpr (detect_v<wmt::on_nchittest_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_nchittest_t, hittest_position>;
					constexpr const bool integral_return = integral_return_v<wmt::on_ncchittest_t>;
			...
			case WM_NCPAINT:
			{
				if constexpr (detect_v<wmt::on_ncpaint_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncpaint_t, void>;
			...
			case WM_NCACTIVATE:
			{
				if constexpr (detect_v<wmt::on_ncactivate_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_ncactivate_t, bool>;
			...
			case WM_GETDLGCODE:
			{
				if constexpr (detect_v<wmt::on_getdlgcode_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_getdlgcode_t, get_dlg_code_return>;
					constexpr const bool integral_return = integral_return_v<wmt::on_getdlgcode_t>;
					...
					constexpr bool same_ret = same_return_v<wmt::on_getdlgcode_t, get_dlg_code_return>;
			...
			case WM_SYNCPAINT:
			{
				if constexpr (detect_v<wmt::on_syncpaint_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_syncpaint_t, void>;
			...
			case WM_NCMOUSEMOVE:
			{
				if constexpr (detect_v<wmt::on_ncmousemove_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmousemove_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_nclbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_nclbuttondown_t, void>;
			...
			case WM_NCLBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_nclbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_nclbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_nclbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_nclbuttondblclk_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncrbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncrbuttondown_t, void>;
			...
			case WM_NCRBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_ncrbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncrbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncrbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncrbuttondblclk_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncmbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmbuttondown_t, void>;
			...
			case WM_NCMBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_ncmbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncmbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmbuttondblclk_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncxbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncxbuttondown_t, void>;
			...
			case WM_NCXBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_ncxbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncxbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncxbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncxbuttondblclk_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_input_device_change_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_input_device_change_t, void>;
			...
			case WM_INPUT:
			{
				if constexpr (detect_v<wmt::on_input_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_input_t, void>;
			...
			case WM_KEYDOWN:
			{
				if constexpr (detect_v<wmt::on_keydown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_keydown_t, void>;
			...
			case WM_KEYUP:
			{
				if constexpr (detect_v<wmt::on_keyup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_keyup_t, void>;
			...
			case WM_CHAR:
			{
				if constexpr (detect_v<wmt::on_char_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_char_t, void>;
			...
			case WM_DEADCHAR:
			{
				if constexpr (detect_v<wmt::on_deadchar_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_deadchar_t, void>;
			...
			case WM_SYSKEYDOWN:
			{
				if constexpr (detect_v<wmt::on_syskeydown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_syskeydown_t, void>;
			...
			case WM_SYSKEYUP:
			{
				if constexpr (detect_v<wmt::on_syskeyup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_syskeyup_t, void>;
			...
			case WM_SYSCHAR:
			{
				if constexpr (detect_v<wmt::on_syschar_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_syschar_t, void>;
			...
			case WM_SYSDEADCHAR:
			{
				if constexpr (detect_v<wmt::on_sysdeadchar_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_sysdeadchar_t, void>;
			...
			case WM_UNICHAR:
			{
				...
				if constexpr (detect_v<wmt::on_unichar_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_unichar_t, void>;
			...
			case WM_COMMAND:
			{
				if constexpr (detect_v<wmt::on_command_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_command_t, bool>;
			...
			case WM_SYSCOMMAND:
			{
				if constexpr (detect_v<wmt::on_syscommand_t> || detect_v<wmt::get_commandhandler_t>)
				{
					...
					if constexpr (detect_v<wmt::on_syscommand_t>)
					{
						constexpr const bool convertable_bool = convertable_return_v<wmt::on_syscommand_t, bool>;
			...
			case WM_TIMER:
			{
				if constexpr (detect_v<wmt::on_timer_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_timer_t, void>;
			...
			case WM_HSCROLL:
			{
				if constexpr (detect_v<wmt::on_hscroll_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_hscroll_t, void>;
			...
			case WM_VSCROLL:
			{
				if constexpr (detect_v<wmt::on_vscroll_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_vscroll_t, void>;
			...
			case WM_INITMENU:
			{
				if constexpr (detect_v<wmt::on_initmenu_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_initmenu_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_initmenupopup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_initmenupopup_t, void>;
			...
			case WM_GESTURE:
			{
				if constexpr (detect_v<wmt::on_gesture_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_gesture_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_gesturenotify_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_gesturenotify_t, void>;
			...
			case WM_MENUSELECT:
			{
				if constexpr (detect_v<wmt::on_menuselect_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_menuselect_t, void>;
			...
			case WM_MENUCHAR:
			{
				if constexpr (detect_v<wmt::on_menuchar_t>)
				{
					constexpr const bool return_menuchar_return = same_return_v<wmt::on_menuchar_t, menuchar_return>;
			...
			case WM_ENTERIDLE:
			{
				if constexpr (detect_v<wmt::on_enteridle_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_enteridle_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_menurbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_menurbuttonup_t, void>;
			...
			case WM_MENUDRAG:
			{
				if constexpr (detect_v<wmt::on_menudrag_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_menudrag_t, menudrag_return>;
					constexpr const bool integral_return = integral_return_v<wmt::on_menudrag_t>;
			...
			{
				if constexpr (detect_v<wmt::on_menugetobject_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_menugetobject_t, menugetobject_return>;
					constexpr const bool integral_return = integral_return_v<wmt::on_menugetobject_t>;
			...
			{
				if constexpr (detect_v<wmt::on_uninitmenupopup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_uninitmenupopup_t, void>;
			...
			case WM_MENUCOMMAND:
			{
				if constexpr (detect_v<wmt::on_menucommand_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_menucommand_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_changeuistate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_changeuistate_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_updateuistate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_updateuistate_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_queryuistate_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_queryuistate_t, uistate_style>;
					constexpr const bool integral_return = integral_return_v<wmt::on_queryuistate_t>;
			...
			{
				if constexpr (detect_v<wmt::on_ctlcolormsgbox_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolormsgbox_t, HBRUSH>;
			...
			{
				if constexpr (detect_v<wmt::on_ctlcoloredit_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcoloredit_t, HBRUSH>;
			...
			{
				if constexpr (detect_v<wmt::on_ctlcolorlistbox_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolorlistbox_t, HBRUSH>;
			...
			case WM_CTLCOLORBTN:
			{
				if constexpr (detect_v<wmt::on_ctlcolorbtn_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolorbtn_t, HBRUSH>;
			...
			case WM_CTLCOLORDLG:
			{
				if constexpr (detect_v<wmt::on_ctlcolordlg_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolordlg_t, HBRUSH>;
			...
			{
				if constexpr (detect_v<wmt::on_ctlcolorscrollbar_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolorscrollbar_t, HBRUSH>;
			...
			{
				if constexpr (detect_v<wmt::on_ctlcolorstatic_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_ctlcolorstatic_t, HBRUSH>;
			...
			case MN_GETHMENU:
			{
				if constexpr (detect_v<wmt::on_gethmenu_t>)
				{
					constexpr const bool return_hbrush = same_return_v<wmt::on_gethmenu_t, HMENU>;
			...
			case WM_MOUSEMOVE:
			{
				if constexpr (detect_v<wmt::on_mousemove_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mousemove_t, void>;
			...
			case WM_LBUTTONDOWN:
			{
				if constexpr (detect_v<wmt::on_lbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_lbuttondown_t, void>;
			...
			case WM_LBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_lbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_lbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_lbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_lbuttondblclk_t, void>;
			...
			case WM_RBUTTONDOWN:
			{
				if constexpr (detect_v<wmt::on_rbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_rbuttondown_t, void>;
			...
			case WM_RBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_rbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_rbuttonup_t, void>;
					if constexpr (return_type_assert) static_assert(return_void, "on_rbuttondown with a return that is not void found. Ignoring return.");
			...
			{
				if constexpr (detect_v<wmt::on_rbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_rbuttondblclk_t, void>;
			...
			case WM_MBUTTONDOWN:
			{
				if constexpr (detect_v<wmt::on_mbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mbuttondown_t, void>;
			...
			case WM_MBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_mbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_mbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mbuttondblclk_t, void>;
			...
			case WM_MOUSEWHEEL:
			{
				if constexpr (detect_v<wmt::on_mousewheel_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mousewheel_t, void>;
			...
			case WM_XBUTTONDOWN:
			{
				if constexpr (detect_v<wmt::on_xbuttondown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_xbuttondown_t, void>;
			...
			case WM_XBUTTONUP:
			{
				if constexpr (detect_v<wmt::on_xbuttonup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_xbuttonup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_xbuttondblclk_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_xbuttondblclk_t, void>;
			...
			case WM_MOUSEHWHEEL:
			{
				if constexpr (detect_v<wmt::on_mousehwheel_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mousehwheel_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_parentnotify_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_parentnotify_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_entermenuloop_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_entermenuloop_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_exitmenuloop_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_exitmenuloop_t, void>;
			...
			case WM_SIZING:
			{
				if constexpr (detect_v<wmt::on_sizing_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_sizing_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_capturechanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_capturechanged_t, void>;
			...
			case WM_MOVING:
			{
				if constexpr (detect_v<wmt::on_moving_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_moving_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_powerbroadcast_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_powerbroadcast_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_devicechange_t>)
				{
					constexpr const bool return_bool = same_return_v<wmt::on_devicechange_t, bool>;
					constexpr const bool return_cbool = convertable_return_v<wmt::on_devicechange_t, bool>;
					constexpr const bool return_void = same_return_v<wmt::on_devicechange_t, void>;
			...
			case WM_TOUCH:
			{
				if constexpr (detect_v<wmt::on_touch_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_touch_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncpointerupdate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncpointerupdate_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncpointerdown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncpointerdown_t, void>;
			...
			case WM_NCPOINTERUP:
			{
				if constexpr (detect_v<wmt::on_ncpointerup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncpointerup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerupdate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerupdate_t, void>;
			...
			case WM_POINTERDOWN:
			{
				if constexpr (detect_v<wmt::on_pointerdown_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerdown_t, void>;
			...
			case WM_POINTERUP:
			{
				if constexpr (detect_v<wmt::on_pointerup_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerup_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerenter_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerenter_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerleave_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerleave_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointeractivate_t>)
				{
					constexpr const bool convertable_to_return = convertable_return_v<wmt::on_pointeractivate_t, pointer_activate_type>;
					constexpr const bool integral_return = integral_return_v<wmt::on_pointeractivate_t>;
			...
			{
				if constexpr (detect_v<wmt::on_pointercapturechanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointercapturechanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_touchhittesting_t>)
				{
					constexpr const bool return_lresult = same_return_v<wmt::on_touchhittesting_t, LRESULT>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerwheel_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerwheel_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerhwheel_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerhwheel_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerhittest_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerhittest_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerroutedto_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerroutedto_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerroutedaway_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerroutedaway_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_pointerroutedreleased_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_pointerroutedreleased_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncmousehover_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmousehover_t, void>;
			...
			case WM_MOUSEHOVER:
			{
				if constexpr (detect_v<wmt::on_mousehover_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mousehover_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_ncmouseleave_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_ncmouseleave_t, void>;
			...
			case WM_MOUSELEAVE:
			{
				if constexpr (detect_v<wmt::on_mouseleave_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_mouseleave_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_wtssession_change_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_wtssession_change_t, void>;
			...
			case WM_DPICHANGED:
			{
				if constexpr (detect_v<wmt::on_dpichanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dpichanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dpichanged_beforeparent_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dpichanged_beforeparent_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dpichanged_afterparent_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dpichanged_afterparent_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_getdpiscaledsize_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_getdpiscaledsize_t, bool>;
			...
			case WM_CUT:
			{
				if constexpr (detect_v<wmt::on_cut_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_cut_t, void>;
			...
			case WM_COPY:
			{
				if constexpr (detect_v<wmt::on_copy_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_copy_t, bool>;
			...
			case WM_PASTE:
			{
				if constexpr (detect_v<wmt::on_paste_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_paste_t, void>;
			...
			case WM_CLEAR:
			{
				if constexpr (detect_v<wmt::on_clear_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_clear_t, void>;
			...
			case WM_UNDO:
			{
				if constexpr (detect_v<wmt::on_undo_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_undo_t, bool>;
			...
			{
				if constexpr (detect_v<wmt::on_renderformat_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_renderformat_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_renderallformats_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_renderallformats_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_destroyclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_destroyclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_drawclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_drawclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_paintclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_paintclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_vscrollclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_vscrollclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_sizeclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_sizeclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_askcbformatname_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_askcbformatname_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_changecbchain_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_changecbchain_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_hscrollclipboard_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_hscrollclipboard_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_querynewpalette_t>)
				{
					constexpr const bool convertable_bool = convertable_return_v<wmt::on_querynewpalette_t, bool>;
			...
			{
				if constexpr (detect_v<wmt::on_paletteischanging_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_paletteischanging_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_palettechanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_palettechanged_t, void>;
			...
			case WM_HOTKEY:
			{
				if constexpr (detect_v<wmt::on_hotkey_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_hotkey_t, void>;
			...
			case WM_PRINT:
			{
				if constexpr (detect_v<wmt::on_print_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_print_t, void>;
			...
			case WM_PRINTCLIENT:
			{
				if constexpr (detect_v<wmt::on_printclient_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_printclient_t, void>;
			...
			case WM_APPCOMMAND:
			{
				if constexpr (detect_v<wmt::on_appcommand_t> || detect_v<wmt::get_commandhandler_t>)
				{
					...
					if constexpr (detect_v<wmt::on_appcommand_t>)
					{
						constexpr const bool convertable_bool = convertable_return_v<wmt::on_appcommand_t, bool>;
			...
			{
				if constexpr (detect_v<wmt::on_themechanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_themechanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_clipboardupdate_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_clipboardupdate_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dwmncrenderingchanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dwmncrenderingchanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dwmcolorizationcolorchanged_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dwmcolorizationcolorchanged_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dwmwindowmaximizedchange_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dwmwindowmaximizedchange_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dwmsendiconicthumbnail_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dwmsendiconicthumbnail_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_dwmsendiconiclivepreviewbitmap_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_dwmsendiconiclivepreviewbitmap_t, void>;
			...
			{
				if constexpr (detect_v<wmt::on_gettitlebarinfoex_t>)
				{
					constexpr const bool return_void = same_return_v<wmt::on_gettitlebarinfoex_t, void>;
		...
		static LRESULT window_proc_seh(HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam)
		{
			...
			if (that != nullptr)
			{
				...
				if (msg == WM_NCDESTROY)
				{
					if constexpr (details::detect_v<window_msg_types::on_ncdestroy_t>)
					{
		...
		static LRESULT window_proc_init_seh(HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam)
		{
			...
			else
			{
				...
				if constexpr (details::detect_v<window_msg_types::on_nccreate_t>)
				{
