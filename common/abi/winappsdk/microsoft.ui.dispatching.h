...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            namespace Dispatching {
                /* [object, uuid("910B5AAC-3310-563E-8418-F3005579729E"), exclusiveto, contract] */
...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            namespace Dispatching {
                /* [object, uuid("14A7A175-5C27-5A35-B079-21960CF764A8"), exclusiveto, contract] */
                ...
                public:
                    ...
                    /* [overload] */virtual HRESULT STDMETHODCALLTYPE RunEventLoop(void) = 0;
                    /* [overload] */virtual HRESULT STDMETHODCALLTYPE RunEventLoopWithOptions(
                        /* [in] */ABI::Microsoft::UI::Dispatching::DispatcherRunOptions options,
                        /* [in] */ABI::Microsoft::UI::Dispatching::IDispatcherExitDeferral * deferral
                        ) = 0;
                    /* [eventadd] */virtual HRESULT STDMETHODCALLTYPE add_FrameworkShutdownStarting(
                        /* [in] */__FITypedEventHandler_2_Microsoft__CUI__CDispatching__CDispatcherQueue_Microsoft__CUI__CDispatching__CDispatcherQueueShutdownStartingEventArgs * handler,
                        /* [retval, out] */EventRegistrationToken * token
                        ) = 0;
                    /* [eventremove] */virtual HRESULT STDMETHODCALLTYPE remove_FrameworkShutdownStarting(
                        /* [in] */EventRegistrationToken token
                        ) = 0;
                    /* [eventadd] */virtual HRESULT STDMETHODCALLTYPE add_FrameworkShutdownCompleted(
                        /* [in] */__FITypedEventHandler_2_Microsoft__CUI__CDispatching__CDispatcherQueue_IInspectable * handler,
                        /* [retval, out] */EventRegistrationToken * token
                        ) = 0;
                    /* [eventremove] */virtual HRESULT STDMETHODCALLTYPE remove_FrameworkShutdownCompleted(
                        /* [in] */EventRegistrationToken token
                        ) = 0;
...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            namespace Dispatching {
                /* [object, uuid("4C68EE2A-1CB1-5591-A3A2-9B590B8F8B9A"), exclusiveto, contract] */
...
typedef struct __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherExitDeferralVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherExitDeferral * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
HRESULT ( STDMETHODCALLTYPE *Complete )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherExitDeferral * This
        );
    END_INTERFACE
...
typedef struct __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3Vtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
HRESULT ( STDMETHODCALLTYPE *EnqueueEventLoopExit )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This
        );
    HRESULT ( STDMETHODCALLTYPE *EnsureSystemDispatcherQueue )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This
        );
    /* [overload] */HRESULT ( STDMETHODCALLTYPE *RunEventLoop )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This
        );
    /* [overload] */HRESULT ( STDMETHODCALLTYPE *RunEventLoopWithOptions )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
        /* [in] */__x_ABI_CMicrosoft_CUI_CDispatching_CDispatcherRunOptions options,
        /* [in] */__x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherExitDeferral * deferral
        );
    /* [eventadd] */HRESULT ( STDMETHODCALLTYPE *add_FrameworkShutdownStarting )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
        /* [in] */__FITypedEventHandler_2_Microsoft__CUI__CDispatching__CDispatcherQueue_Microsoft__CUI__CDispatching__CDispatcherQueueShutdownStartingEventArgs * handler,
        /* [retval, out] */EventRegistrationToken * token
        );
    /* [eventremove] */HRESULT ( STDMETHODCALLTYPE *remove_FrameworkShutdownStarting )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
        /* [in] */EventRegistrationToken token
        );
    /* [eventadd] */HRESULT ( STDMETHODCALLTYPE *add_FrameworkShutdownCompleted )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
        /* [in] */__FITypedEventHandler_2_Microsoft__CUI__CDispatching__CDispatcherQueue_IInspectable * handler,
        /* [retval, out] */EventRegistrationToken * token
        );
    /* [eventremove] */HRESULT ( STDMETHODCALLTYPE *remove_FrameworkShutdownCompleted )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueue3 * This,
        /* [in] */EventRegistrationToken token
        );
    END_INTERFACE
...
typedef struct __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueueController2Vtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueueController2 * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
HRESULT ( STDMETHODCALLTYPE *ShutdownQueue )(
        __x_ABI_CMicrosoft_CUI_CDispatching_CIDispatcherQueueController2 * This
        );
    END_INTERFACE
