...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            /* [object, uuid("478CEC68-EA8E-52FC-87E2-C819DE000F92"), contract] */
...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            /* [object, uuid("2989E93B-ED0F-5E79-90F2-EAC592FC6E6A"), contract] */
            MIDL_INTERFACE("2989E93B-ED0F-5E79-90F2-EAC592FC6E6A")
            IClosableNotifier : public IInspectable
            {
            public:
                /* [propget] */virtual HRESULT STDMETHODCALLTYPE get_IsClosed(
                    /* [retval, out] */::boolean * value
                    ) = 0;
                /* [eventadd] */virtual HRESULT STDMETHODCALLTYPE add_Closed(
                    /* [in] */ABI::Microsoft::UI::IClosableNotifierHandler  * handler,
                    /* [retval, out] */EventRegistrationToken * token
                    ) = 0;
                /* [eventremove] */virtual HRESULT STDMETHODCALLTYPE remove_Closed(
                    /* [in] */EventRegistrationToken token
                    ) = 0;
                /* [eventadd] */virtual HRESULT STDMETHODCALLTYPE add_FrameworkClosed(
                    /* [in] */ABI::Microsoft::UI::IClosableNotifierHandler  * handler,
                    /* [retval, out] */EventRegistrationToken * token
                    ) = 0;
                /* [eventremove] */virtual HRESULT STDMETHODCALLTYPE remove_FrameworkClosed(
                    /* [in] */EventRegistrationToken token
                    ) = 0;
...
typedef struct __x_ABI_CMicrosoft_CUI_CIClosableNotifierHandlerVtbl
{
    ...
    __RPC__in __x_ABI_CMicrosoft_CUI_CIClosableNotifierHandler * This,
...
HRESULT ( STDMETHODCALLTYPE *Invoke )(
        __x_ABI_CMicrosoft_CUI_CIClosableNotifierHandler * This
        );
    END_INTERFACE
...
typedef struct __x_ABI_CMicrosoft_CUI_CIClosableNotifierVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CIClosableNotifier * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
/* [propget] */HRESULT ( STDMETHODCALLTYPE *get_IsClosed )(
        __x_ABI_CMicrosoft_CUI_CIClosableNotifier * This,
        /* [retval, out] */boolean * value
        );
    /* [eventadd] */HRESULT ( STDMETHODCALLTYPE *add_Closed )(
        __x_ABI_CMicrosoft_CUI_CIClosableNotifier * This,
        /* [in] */__x_ABI_CMicrosoft_CUI_CIClosableNotifierHandler  * handler,
        /* [retval, out] */EventRegistrationToken * token
        );
    ...
    /* [eventadd] */HRESULT ( STDMETHODCALLTYPE *add_FrameworkClosed )(
        __x_ABI_CMicrosoft_CUI_CIClosableNotifier * This,
        /* [in] */__x_ABI_CMicrosoft_CUI_CIClosableNotifierHandler  * handler,
        /* [retval, out] */EventRegistrationToken * token
        );
    /* [eventremove] */HRESULT ( STDMETHODCALLTYPE *remove_FrameworkClosed )(
        __x_ABI_CMicrosoft_CUI_CIClosableNotifier * This,
        /* [in] */EventRegistrationToken token
        );
    END_INTERFACE
