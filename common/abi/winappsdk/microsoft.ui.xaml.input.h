...
namespace ABI {
    namespace Microsoft {
        namespace UI {
            namespace Xaml {
                namespace Input {
                    /* [object, uuid("512C9F63-24AD-5DF2-B8ED-472406DB31C0"), exclusiveto, contract] */
                    MIDL_INTERFACE("512C9F63-24AD-5DF2-B8ED-472406DB31C0")
                    IAccessKeyManagerStatics2 : public IInspectable
                    {
                    public:
                        /* [overload] */virtual HRESULT STDMETHODCALLTYPE EnterDisplayModeForXamlRoot(
...
typedef struct __x_ABI_CMicrosoft_CUI_CXaml_CInput_CIAccessKeyManagerStatics2Vtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_ABI_CMicrosoft_CUI_CXaml_CInput_CIAccessKeyManagerStatics2 * This,
    /* [in] */ __RPC__in REFIID riid,
    /* [annotation][iid_is][out] */
    _COM_Outptr_  void **ppvObject
    );
...
/* [overload] */HRESULT ( STDMETHODCALLTYPE *EnterDisplayModeForXamlRoot )(
        __x_ABI_CMicrosoft_CUI_CXaml_CInput_CIAccessKeyManagerStatics2 * This,
